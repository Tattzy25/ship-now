...
export function ImageDisplay({
  ...
  const placeholderSrc = process.env.NEXT_PUBLIC_PLACEHOLDER_IMAGE_URL;
  ...
  return (
    <>
      <div
        className={cn(
          "relative w-full aspect-square group bg-zinc-50 rounded-2xl",
          image && !failed && "cursor-pointer",
          (!image || failed) && "border border-zinc-100",
        )}
        ...
        {image ? (
          <>
            ...
            <img
              ...
              className="w-full h-full object-contain rounded-2xl mx-auto"
            />
            <Button
              size="icon"
              variant="secondary"
